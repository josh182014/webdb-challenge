...
A RDBMS is a Relational Database Management System. It is the software that manages the database. SQL is Structure Query Language and is the language that is used to communicate with the RDBMS. So sqlite3 is a RDBMS.

1. Why do tables need a `primary key`?

Tables must have a primary key to differentiate each item from each other.
...
We need a third table in the middle to manage the identification of each of the other tables keys. 
